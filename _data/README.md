...
| **`queries.yaml`** | Curated **remote job** boards, portals, and awesome-list links, grouped into **sections**. Feeds **resources.html** and **[docs/search-queries-and-resources.md](../docs/search-queries-and-resources.md)**. Tips & notes on that page come from **`readme.yaml`** → `footer.notes`, not from this file. |
